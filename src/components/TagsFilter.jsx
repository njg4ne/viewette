...
import { tags, tagIncludeFilter, tagExcludeFilter, tagRequirementFilter } from '../signals/Filesystems';
...
function Filter(props) {
    ...
    return (<TagChooser onChange={onChange} label={label} options={tagEntries} defaultValue={[]} />)
    // return (
    //     <Autocomplete
    //         multiple
    //         id="tags-outlined"
...
export function TagChooser(props) {
    const { onChange, label, options, ...rest } = props;
    return (
        <Autocomplete
            multiple
            {...rest}
